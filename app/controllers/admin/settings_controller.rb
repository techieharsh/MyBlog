class Admin::SettingsController < Admin::ApplicationController
  ...
  def update
    ...
    if @setting.update(setting_params)
      redirect_to edit_admin_setting_path(@setting), notice: 'Successfully updated setting'
    else
  ...
  def setting_params
    params.require(:setting).permit(:id, :site_name, :post_per_page, :under_maintenance,
      :prevent_commenting, :tag_visibility)
  end
end
